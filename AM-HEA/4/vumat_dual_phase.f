...
C     BH : backstress hardening
      PARAMETER(NOEL=8000,NCRYS=1,NSLIP=12,BH=0.0)
...
C           endif       
      ...
      FILE1 = '~/AlHEA/4/aeuler'
      FILE2 = '~/AlHEA/4/slipsys'
      FILE3 = '~/AlHEA/4/VU_MESSAGES'
      FILE4 = '~/AlHEA/4/VU_TEXTURES'
      FILE5 = '~/AlHEA/4/VU_SLIPS'
